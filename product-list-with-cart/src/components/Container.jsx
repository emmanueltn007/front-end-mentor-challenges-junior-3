...
function Container() {
  ...
  return (
    <div className="max-md:px-4 max-md:py-8 md:p-12 lg:p-16">
            ...
            return (
              <div key={item.name} className="flex flex-col gap-8">
                <div className="relative">
                  ...
                  <button className="flex items-center gap-1 absolute bottom-0 translate-y-1/2 -translate-x-1/2 left-1/2 cursor-pointer bg-[hsl(20,50%,98%)] px-4 py-2 border border-[hsl(12,20%,44%)] rounded-3xl text-[hsl(14,65%,9%)] font-semibold">
